...
if(isset($_GET['applicant_number'])){
	...
	if(mysqli_num_rows($query_run)>0){
	 ...
	 $pdf->Cell(37, 5, 'First Name:', 0, 0, 'L');
	
	 $pdf->SetFont('helvetica', '', 12); // reset font to regular, size 12
	 $pdf->Cell(50, 5, ucfirst(strtolower($applicant['firstname'])), 0, 1, 'L');


	 $pdf->SetFont('helvetica', 'B', 12);
	 $pdf->Cell(37, 5, 'Middle Name:', 0, 0, 'L');
	 $pdf->SetFont('helvetica', '', 12);
	 $pdf->Cell(30, 5, ucfirst(strtolower($applicant['middlename'])), 0, 1, 'L');
	 $pdf->SetFont('helvetica', 'B', 12);

	 $pdf->Cell(37, 5, 'Last Name:', 0, 0, 'L');
	 $pdf->SetFont('helvetica', '', 12);
	 $pdf->Cell(30, 5, ucfirst(strtolower($applicant['lastname'])), 0, 1, 'L');
	 $pdf->SetFont('helvetica', 'B', 12);

	 $pdf->Cell(37, 5, 'Birthplace:', 0, 0, 'L');
	 $pdf->SetFont('helvetica', '', 12);
	 $pdf->Cell(37, 5, ucfirst(strtolower($applicant['birthplace'])), 0, 1, 'L');


	 $pdf->SetFont('helvetica', 'B', 12);
	 $pdf->Cell(37, 5, 'Birthdate:', 0, 0, 'L');
	 $pdf->SetFont('helvetica', '', 12);
	 $pdf->Cell(37, 5, $applicant['birthdate'], 0, 1, 'L');
	 $pdf->SetFont('helvetica', 'B', 12);
	 $pdf->Cell(37, 5, 'Age:', 0, 0, 'L');
	 $pdf->SetFont('helvetica', '', 12);
	 ...
	 $pdf->SetFont('helvetica', 'B', 12);
	 $pdf->Cell(37, 5, 'Gender:', 0, 0, 'L');
	 $pdf->SetFont('helvetica', '', 12);
	 $pdf->Cell(37, 5, ucfirst(strtolower($applicant['gender'])), 0, 1, 'L');
	 $pdf->SetFont('helvetica', 'B', 12);
	 $pdf->Cell(37, 5, 'Email Address:', 0, 0, 'L');
	 $pdf->SetFont('helvetica', '', 12);
$pdf->Cell(50, 5, $applicant['emails'], 0, 1, 'L');

$pdf->SetFont('helvetica', 'B', 12);

$pdf->Cell(37, 5, 'Contact Number:', 0, 0, 'L');
$pdf->SetFont('helvetica', '', 12);
$pdf->Cell(37, 5, $applicant['contact'], 0, 1, 'L');
$pdf->SetFont('helvetica', 'B', 12);
$pdf->Cell(37, 5, 'Civil Status:', 0, 0, 'L');
$pdf->SetFont('helvetica', '', 12);
$pdf->Cell(20, 5, ucfirst(strtolower($applicant['civil_status'])), 0, 1, 'L');

$pdf->SetFont('helvetica', 'B', 12);
$pdf->Cell(37, 5, 'Province:', 0, 0, 'L');
$pdf->SetFont('helvetica', '', 12);
$pdf->Cell(45, 5, ucfirst(strtolower($applicant['province'])), 0, 1, 'L');




$pdf->SetFont('helvetica', 'B', 12);
$pdf->Cell(37, 5, 'City:', 0, 0, 'L');
$pdf->SetFont('helvetica', '', 12);
$pdf->Cell(37, 5, ucfirst(strtolower($applicant['city'])), 0, 1, 'L');
$pdf->SetFont('helvetica', 'B', 12);


$pdf->SetFont('helvetica', 'B', 12);
 $pdf->Cell(37, 5, 'Street:', 0, 0, 'L');
$pdf->SetFont('helvetica', '', 12);
$pdf->Cell(25, 5, ucfirst(strtolower($applicant['street'])), 0, 1, 'L');
$pdf->SetFont('helvetica', 'B', 12);
// $pdf->Cell(50, 5, ucfirst(strtolower('')), 0, 0, 'L');
$pdf->SetFont('helvetica', 'B', 12);
	 $pdf->Cell(37, 5, 'Barangay:', 0, 0, 'L');
	 $pdf->SetFont('helvetica', '', 12);
	 $pdf->Cell(24, 5, ucfirst(strtolower($applicant['barangay'])), 0, 1, 'L');


	 $pdf->SetFont('helvetica', 'B', 12);
	 $pdf->Cell(37, 5, 'Postal Code:', 0, 0, 'L');
	 $pdf->SetFont('helvetica', '', 12);
...
//college
	 $pdf->SetFont('helvetica', 'B', 12);
	 $pdf->Cell(43, 5, 'College:', 0, 0, 'L');
     $pdf->SetFont('helvetica', '', 12);
	 $pdf->Cell(28, 5, ucfirst(strtolower($applicant['college'])), 0, 1, 'L');
	 $pdf->SetFont('helvetica', 'B', 12);

	 //program
	 $pdf->SetFont('helvetica', 'B', 12);
	 $pdf->Cell(43, 5, 'Program:', 0, 0, 'L');
     $pdf->SetFont('helvetica', '', 12);
	 $pdf->Cell(28, 5, ucfirst(strtolower($applicant['program'])), 0, 1, 'L');
	 $pdf->SetFont('helvetica', 'B', 12);

	 //cyear_grad
	 $pdf->SetFont('helvetica', 'B', 12);
	 $pdf->Cell(43, 5, 'Year Graduated:', 0, 0, 'L');
     $pdf->SetFont('helvetica', '', 12);
...
//seniorhighschool
	 ...
	 $pdf->Cell(43, 5, 'Program:', 0, 0, 'L');
     $pdf->SetFont('helvetica', '', 12);
	 $pdf->Cell(50, 5, ucfirst(strtolower($applicant['S_program'])), 0, 1, 'L');
	 $pdf->SetFont('helvetica', 'B', 12);
	 ...
	 $pdf->Cell(50, 5, ucfirst(strtolower('')), 0, 1, 'L');
	  ...
	  //J_high
	  $pdf->SetFont('helvetica', 'B', 12);
	  $pdf->Cell(43, 5, 'Junior high School:', 0, 0, 'L');
	  $pdf->SetFont('helvetica', '', 12);
	  ...
	  $pdf->SetFont('helvetica', 'B', 12);
	   ...
	   //Jyear_grad
	 $pdf->SetFont('helvetica', 'B', 12);
	 $pdf->Cell(43, 9, 'Year Graduated:', 0, 0, 'L');
     $pdf->SetFont('helvetica', '', 12);
	 $pdf->Cell(50, 9, ucfirst(strtolower($applicant['Jyear_grad'])), 0, 1, 'L');
	 $pdf->SetFont('helvetica', 'B', 12);
	 ...
	 $pdf->Cell(50, 5, ucfirst(strtolower('')), 0, 1, 'L');
	  ...
	  //elem
	  $pdf->SetFont('helvetica', 'B', 12);
	  $pdf->Cell(43, 5, 'Elementary:', 0, 0, 'L');
	  $pdf->SetFont('helvetica', '', 12);
...
//first work exp
	...
	if(mysqli_num_rows($query_run)>0){
	 ...
	 //work_date_start
	 $pdf->SetFont('helvetica', 'B', 12);
	 $pdf->Cell(45, 5, 'Work date start:', 0, 0, 'L');
     $pdf->SetFont('helvetica', '', 12);
	 $pdf->Cell(48, 5, ucfirst(strtolower($applicant['work_date_start'])), 0, 1, 'L');
	 $pdf->SetFont('helvetica', 'B', 12);
	 $pdf->SetFont('helvetica', '', 12);
...
//date_ended
	 $pdf->SetFont('helvetica', 'B', 12);
	 $pdf->Cell(45, 5, 'Work date Ended:', 0, 0, 'L');
     $pdf->SetFont('helvetica', '', 12);
	 ...
	 //company_name
	 $pdf->SetFont('helvetica', 'B', 12);
	 $pdf->Cell(45, 5, 'Company Name:', 0, 0, 'L');
     $pdf->SetFont('helvetica', '', 12);
	 $pdf->Cell(50, 5, ucfirst(strtolower($applicant['company_name'])), 0, 1, 'L');
	 $pdf->SetFont('helvetica', 'B', 12);
	 $pdf->SetFont('helvetica', '', 12);
	 
	 //company_add
	 $pdf->SetFont('helvetica', 'B', 12);
	 $pdf->Cell(45, 5, 'Company Address:', 0, 0, 'L');
     $pdf->SetFont('helvetica', '', 12);
