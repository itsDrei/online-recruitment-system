        ...
        <div class ="col-md-15">
            <div class ="card">
                <div class="card-header">
                    <h4>
                        Form Edit
                        <a href="adminDatatable.php" class = "btn btn-danger float-end">Back</a>
...
<div class="col-lg-2">
  ...
  <option value="other" <?php if ($reference_no['gender'] === 'Rather Not Say') { echo 'selected'; } ?>>Rather Not Say</option>
</select>
        </div>
  </div>
 <br>
