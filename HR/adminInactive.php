    ...
    <?php
                     ...
                     if(isset($_GET['applicant_number'])){
                       ...
                       if(mysqli_num_rows($query_run)>0){
                        ...
                        ?>
                        <form action="adminInactive.php" method="post">
...
<!-- <a href="PDF.php?applicant_number=<?=$applicant['applicant_number'];?>" class = "btn btn-danger float-end" target="_blank">PDF</a> -->
    ...
    <a style="margin-left:5.5%;" href="adminDataTable.php" class="btn btn-primary">Back</a>
...
if($query_run) {
  ...
  $activity = "Admin set applicant number <b>$applicant_number</b> to <b> Inactive </b> due to<b> $reason </b>";
...
window.location.href = 'adminInactive.php';
});
</script>";
}
